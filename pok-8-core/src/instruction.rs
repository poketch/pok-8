...
pub enum Instruction {
    ...
    INCVNN(u16, u16), // 7XNN - VX += 0xNN (Doesn't affect carry flag)
    ...
    DRAW(u16, u16), // DXYN - Draw sprite at (VX, VY) N pixels tall, on/off based on I. VF set if any pixels flipped
